...
CREATE TABLE IF NOT EXISTS "astrologer_profiles" (
	...
	"cashfree_vendor_id" varchar(64),
	"cashfree_vendor_status" varchar(32),
	"cashfree_vendor_response" jsonb,
	"cashfree_vendor_created_at" timestamp with time zone,
	"meta" jsonb,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "astrologer_profiles_user_id_unique" UNIQUE("user_id"),
	CONSTRAINT "astrologer_profiles_cashfree_vendor_id_unique" UNIQUE("cashfree_vendor_id")
);
--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "payments" (
	...
	"platform_commission_percentage" numeric(5, 2),
	"astrologer_payout_amount" numeric(10, 2),
...
CREATE TABLE IF NOT EXISTS "vendor_settlements" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"astrologer_id" uuid NOT NULL,
	"cashfree_vendor_id" varchar(64) NOT NULL,
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "vendor_settlements" ADD CONSTRAINT "vendor_settlements_astrologer_id_users_id_fk" FOREIGN KEY ("astrologer_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "payments_cashfree_order_id_idx" ON "payments" USING btree ("cashfree_order_id");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "vendor_settlements_astrologer_id_idx" ON "vendor_settlements" USING btree ("astrologer_id");--> statement-breakpoint
